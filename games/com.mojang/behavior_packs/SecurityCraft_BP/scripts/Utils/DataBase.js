...
class DataBase {
    ...
    **/
    static deleteOwner(location, player, block) {
    ...
    **/
    static setOwner(location, player, type, name) {
        const list = this.getIds();
        const pos = this.pos(location);
        const id = `${pos.x} ${pos.y} ${pos.z}`;
    ...
    **/
    static getOwner(location, playerId) {
    ...
    @throws Gets the owner
    **/
    static deleteOwnerUniversal(location, block) {
